...
public class DashboardFeedbackFragment extends ActionBarFragment
{
    ...
    public void switchToVideoLibrary()
    {
        ...
        bus.post(new NavigationEvent.NavigateToTab(AppPage.DASHBOARD_VIDEO_LIBRARY, true));
    }
    ...
    public void swapToVideo(String youtubeId)
    {
        ...
        bus.post(new NavigationEvent.NavigateToTab(AppPage.YOUTUBE_PLAYER, bundle));
    }
}
