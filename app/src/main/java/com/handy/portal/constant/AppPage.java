...
/**
 * a page/screen of this application
 */
public enum AppPage implements Serializable
{
    ...
    AppPage(Class classType)
    {
        mClassType = classType;
    }

    AppPage(Class classType, @WebUrlManager.TargetPage String target)
    {
        mClassType = classType;
