...
import com.handy.portal.bookings.model.Booking.BookingStatus;
import com.handy.portal.bookings.model.Booking.BookingType;
import com.handy.portal.bookings.model.BookingClaimDetails;
import com.handy.portal.bookings.ui.element.BookingActionButton;
import com.handy.portal.bookings.ui.element.BookingDetailsActionContactPanelView;
import com.handy.portal.bookings.ui.element.BookingDetailsActionPanelView;
import com.handy.portal.bookings.ui.element.BookingDetailsDateView;
import com.handy.portal.bookings.ui.element.BookingDetailsJobInstructionsView;
import com.handy.portal.bookings.ui.element.BookingDetailsTitleView;
import com.handy.portal.bookings.ui.element.ProxyLocationView;
...
//Display Creation / Updating
    ...
    {
        bus.post(new HandyEvent.SetLoadingOverlayVisibility(true));
        bus.post(new LogEvent.AddLogEvent(new CheckInFlowLog.OnMyWaySubmitted(mAssociatedBooking, locationData)));
    ...
    {
        bus.post(new HandyEvent.SetLoadingOverlayVisibility(true));
        bus.post(new LogEvent.AddLogEvent(new CheckInFlowLog.CheckInSubmitted(mAssociatedBooking, locationData)));
