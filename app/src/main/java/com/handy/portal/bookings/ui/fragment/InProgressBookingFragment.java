...
public class InProgressBookingFragment extends TimerActionBarFragment
{
    ...
    public void swapToJobDetails()
    {
        ...
        bus.post(new NavigationEvent.NavigateToTab(AppPage.NOT_IN_PROGRESS_JOB_DETAILS, args, true));
    }
    ...
    public void checkOut()
    {
        ...
        if (proReportedNoShow || mBooking.isAnyPreferenceChecked())
        {
            ...
            bus.post(new NavigationEvent.NavigateToTab(AppPage.SEND_RECEIPT_CHECKOUT, bundle, true));
        }
        else
        {
