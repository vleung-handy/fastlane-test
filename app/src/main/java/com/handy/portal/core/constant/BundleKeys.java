...
public class BundleKeys {
    ...
    public static final String PAYMENT_CASH_OUT_INFO = "payment_cash_out_info";
    public static final String IS_CURRENT_WEEK_PAYMENT_BATCH = "is_current_week_payment_batch";
