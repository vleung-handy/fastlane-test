package com.handy.portal.helpcenter.constants;

/**
 * holds all the hard-coded help center urls that we should actually not hard-code
 */
public class HelpCenterUrl {
