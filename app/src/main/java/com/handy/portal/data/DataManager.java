...
public abstract class DataManager
{
    ...
    public abstract void getAvailableBookings(Date date, Callback<BookingList> cb);

    public abstract void getScheduledBookings(Date date, Callback<BookingList> cb);
