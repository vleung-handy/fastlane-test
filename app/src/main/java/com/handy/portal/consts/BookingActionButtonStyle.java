...
public enum BookingActionButtonStyle
{
    ...
    CHECK_OUT(R.drawable.button_claimed_blue_round, R.style.Button_ClaimedBlue_Round, R.layout.element_booking_action_button_template),
    CLAIMED_BLUE_EMPTY(R.drawable.button_claimed_blue_empty_round, R.style.Button_ClaimedBlueEmpty_Round, R.layout.element_booking_action_button_template),
